...
import com.acsm.utils.SystemBarTintManager;

import java.io.File;
import java.util.ArrayList;

import static com.acsm.MultiImageSelectorFragment.REQUEST_CAMERA_multi;
import static com.acsm.MultiImageSelectorFragment.mTmpFile;
...
public class MultiImageSelectorActivity extends AppCompatActivity implements MultiImageSelectorFragment.Callback{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setStatusBarColor(R.color.preview_page);
    ...
    public ArrayList<String> mPreview;
    @Override
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if(resultCode==35){
            mPreview = data.getStringArrayListExtra("preview");
            data.putStringArrayListExtra(EXTRA_RESULT,mPreview);
            setResult(RESULT_OK,data);
            finish();
        }else if(requestCode == REQUEST_CAMERA_multi && resultCode == Activity.RESULT_OK){
            if (mTmpFile != null) {
