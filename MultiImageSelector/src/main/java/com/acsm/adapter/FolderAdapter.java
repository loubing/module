...
//                    Folder f = mFolders.get(0);
                    Glide.with(mContext)
                            .load(mFolders.get(i).cover.getPath())
    ...
    class ViewHolder {
        ...
        void bindData(Folder data) {
            ...
            if (data.getImages() != null) {
                size.setText(String.format("%d%s", data.getImages().size(), mContext.getResources().getString(R.string
                        .mis_photo_unit)));
            } else {
